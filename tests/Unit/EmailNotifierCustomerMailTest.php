...
final class EmailNotifierCustomerMailTest extends TestCase
{
    public function testItSendsCustomerMailWhenCustomerEmailFieldIsValid(): void
    {
        ...
        $wizard->method('isDisableAdminMails')->willReturn(true);
        $wizard->method('isDisableCustomerMails')->willReturn(false);
        $wizard->method('getCustomerEmailToField')->willReturn('email');
        ...
        $wizard->method('getMailTextCustomer')->willReturn(null);
